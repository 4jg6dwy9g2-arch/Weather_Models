...
function winner(models) {{
  ...
  return ws.length===1 ? [ws[0].n, ws[0].cls, ws[0].style||''] : ['Tie','badge bg-secondary',''];
}}
...
function renderTable() {{
  ...
  for (let i=0; i<v.lead_times.length; i++) {{
    ...
    const [tW,tC,tS]=winner([{{n:'GFS',mae:gTm,cls:'badge bg-primary'}},{{n:'AIFS',mae:aTm,cls:'badge bg-info text-dark'}},{{n:'Kenny',mae:kTm,cls:'badge',style:'background:#fd7e14;'}},{{n:'IFS',mae:iTm,cls:'badge bg-success'}},{{n:'NWS',mae:nTm,cls:'badge bg-dark'}}]);
    const [rW,rC,rS]=winner([{{n:'GFS',mae:isWmae?gRw:gRm,cls:'badge bg-primary'}},{{n:'AIFS',mae:isWmae?aRw:aRm,cls:'badge bg-info text-dark'}},{{n:'Kenny',mae:isWmae?kRw:kRm,cls:'badge',style:'background:#fd7e14;'}},{{n:'IFS',mae:isWmae?iRw:iRm,cls:'badge bg-success'}},{{n:'NWS',mae:isWmae?nRw:nRm,cls:'badge bg-dark'}}]);
    const [dW,dC,dS]=winner([{{n:'GFS',mae:gDm,cls:'badge bg-primary'}},{{n:'AIFS',mae:aDm,cls:'badge bg-info text-dark'}},{{n:'Kenny',mae:kDm,cls:'badge',style:'background:#fd7e14;'}},{{n:'IFS',mae:iDm,cls:'badge bg-success'}},{{n:'NWS',mae:nDm,cls:'badge bg-dark'}}]);
    ...
    tr.innerHTML = `
      ...
      <td><span class="${{tC}}" style="${{tS}}">${{tW}}</span></td>
      ...
      <td><span class="${{rC}}" style="${{rS}}">${{rW}}</span></td>
      ...
      <td><span class="${{dC}}" style="${{dS}}">${{dW}}</span></td>
